...
WITH movie_data AS (
    INSERT INTO movies (title, description, poster_url, backdrop_url, release_year, rating, duration, is_trending, is_popular, is_new_release) VALUES
    (
        'Interstellar', 
